...
<template>
    <div class="bg-black grid grid-cols-7 h-screen">
      <div class="flex flex-col justify-center items-center col-span-4">
        <div class="w-full sm:max-w-md py-8">
          <slot />
        </div>
      </div>
  
      <div class="relative col-span-3">
        <img src="../../../storage/app/public/assets/alien-gc688c9726_1280.jpg" alt="" class="h-screen w-full" />
        <div class="p-10 w-full absolute bottom-0 left-">
          <div class="h-full bg-white p-8 rounded-lg bg-opacity-50">
            <svg
