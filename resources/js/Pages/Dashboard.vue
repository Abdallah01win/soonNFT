...
<template>
    ...
    <AuthenticatedLayout class="bg-myDark-300">
        ...
        <section class="mx-auto my-8 max-w-[1180px]">
            <form
                @submit.prevent="this.submitPost"
            ...
            >
                ...
                <div class="flex items-center gap-x-3 my-4">
                    <div class="w-full">
                        ...
                        <InputError
                            class="mt-2"
                            :message="postForm.errors.postTitle"
                        />
                    </div>
                    <div class="w-full">
                        <select
                        ...
                        <InputError
                            class="mt-2"
                            :message="postForm.errors.postCategory"
                        />
                    </div>
                    <div class="w-full">
                        <lable
                        ...
                        >
                            ...
                            <input
                                class="absolute top-0 left-0 w-full h-[100%] opacity-0"
                                type="file"
                                name="image"
                                id="image"
                                @input="
                                    postForm.postImage = $event.target.files[0]
                                "
                            />
                        </lable>
                        <InputError
                            class="mt-2"
                            :message="postForm.errors.postImage"
                        />
                    </div>
                    <div class="w-full">
                        <TextInput
                        ...
                        <InputError
                            class="mt-2"
                            :message="postForm.errors.postDescription"
                        />
                    </div>
                </div>
                <!-- Editor -->
                <editor
                    ...
                    api-key="qy087j2ri5rtqec2z8zfm30dlp512h2wdodz9lu5gziom42d"
                    :init="{
                        height: 500,
                        menubar: false,
                        plugins: [
