            ...
            <div class="grid grid-cols-[1fr,1.8fr] gap-x-12">
                ...
                <div class="flex flex-col">
                    ...
                    >
                        ...
                        <span class="text-6xl font-inter">
                            {{ nft.name }}
                        </span>
                    </div>
                    <!-- <p>{{ nft.description }}</p> -->
                    ...
                    <div class="grid grid-cols-2 uppercase mb-10">
                        <div
                            class="flex flex-col gap-y-3 border-r border-myGray"
                        >
